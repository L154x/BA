...
\section{Components of design science}
...
\begin{figure}
    \centering
    \includesvg{graphics/DSRKnowledge}
...
\begin{figure}
    \centering
    \includesvg[width=\textwidth]{graphics/ISRFramework}
...
\end{figure}
\footnotetext{With changes taken from \cite{HevnerDesignScienceResearch2004}, p.80.}
...
\begin{enumerate}
    ...
    \item Design as a search process: the search process comprises the abstraction and representation of appropriate means in order to reach desired ends by respecting the laws in the problem space.\footcite[Cf.][pp.83,88-89]{HevnerDesignScienceResearch2004}\footnotetext{The means, ends and laws may be represented mathematically to allow a formal way of computing the solution space via standard operations research techniques. However, the problem and solution space in ISR is often so complex, with humans and organizations as unpredictable variables, that automatically computing the solution is rendered infeasible.}
