...
Ferner gliedert sich dieser Text in folgende Dateien (ebenfalls im Verzeichnis \verb|includes|), die per \lstinline[language=TeX]|\input|-Befehl eingebunden werden:
\begin{verbatim}
...
Um das Editieren (und Debuggen) zu erleichtern, ist es ratsam, ein längeres Dokument in einzelne Dateien zu strukturieren (z.B.\ kapitelweise).
...
\lstset{language=}
\lstinputlisting[firstline=42,lastline=53,firstnumber=42]{latex-vorlage.tex}
...
\lstinputlisting[firstline=19,lastline=36,firstnumber=19]{latex-vorlage.tex}
