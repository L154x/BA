...
\anhang{Screen clipping of the artifact's overview} \label{anhang:OverviewBild}
...
\anhang{Source code of the artifact implementation} \label{anhang:CodeArtifact}
...
\anhangteil{Source code of index.html}
\begin{lstlisting}
<!DOCTYPE html>
<html lang="en">
<head>
...
\anhangteil{Source code of guided-tour.html}
\begin{lstlisting}
<!DOCTYPE html>
...
\anhangteil{Source code of guided-tour-continued.html}
...
\anhangteil{Source code of guided-tour-network.html}
\begin{lstlisting}
<!DOCTYPE html>
<html data-wf-page="5ad485f0d8ce0281af7d3ecc" data-wf-site="5ad485f0d8ce021edb7d3ecd">
<head>
...
<div id="arrow-wrapper">
  <div>
    <a class="arrowOverview" href="overview.html">
  ...
  <div class="sectionbanks">
    <div class="container-7 w-container">
      <div class="rows w-row">
        <div class="columns w-col w-col-2"><img src="images/bank.png" width="57" class="z"></div>
        <div class="w-col w-col-2"></div>
        <div class="w-col w-col-2"></div>
        <div class="w-col w-col-2"><img src="images/bank.png" width="57" class="z"></div>
        <div class="w-col w-col-2"></div>
      ...
      <div class="rows w-row">
        ...
        <div class="w-col w-col-2"><img src="images/bank.png" width="57" class="z"></div>
        <div class="w-col w-col-2"></div>
        <div class="w-col w-col-2"><img src="images/bank.png" width="57" class="image-6 z"></div>
        <div class="w-col w-col-2"></div>
      </div>
      <div class="rows w-row">
        <div class="column-7 w-col w-col-2"><img src="images/bank.png" width="57" class="z"></div>
        <div class="w-col w-col-2"></div>
        <div class="column-8 w-col w-col-2"><img src="images/bank.png" width="57" class="z"></div>
        <div class="w-col w-col-2"></div>
        <div class="w-col w-col-2"><img src="images/bank.png" width="57" class="image-7 z"></div>
        <div class="w-col w-col-2"></div>
      </div>
      <div class="rows w-row">
        <div class="w-col w-col-2"></div>
        <div class="w-col w-col-2"></div>
        <div class="w-col w-col-2"><img src="images/bank.png" width="57" class="image-5 z"></div>
        <div class="w-col w-col-2"></div>
        <div class="w-col w-col-2"></div>
        <div class="w-col w-col-2"><img src="images/bank.png" width="57" class="z"></div>
      </div>
...
\anhangteil{Source code of overview.html}
...
\anhangteil{Source code of consensus.html}
\begin{lstlisting}
<html data-wf-page="5ad485f0d8ce0281af7d3ecc" data-wf-site="5ad485f0d8ce021edb7d3ecd">
<head>
  <meta charset="utf-8">
...
\anhangteil{Source code of hashes.html}
\begin{lstlisting}
<html data-wf-page="5ad485f0d8ce0281af7d3ecc" data-wf-site="5ad485f0d8ce021edb7d3ecd">
<head>
  <meta charset="utf-8">
...
<div id="HashInfo" class="usecasediv hash">
  <p> Hash functions are a form of mathematic one-way functions. With these functions, it is very difficult (or rather impossible) to get back the input values from the output values. This means that when given a hashed value, the only way of finding the source value is to run every combination of values through the function
     until the output matches the given hash. Depending on the kind of one-way function, random guessing (also called brute-forcing) becomes almost impossible. One simple example of such a one-way function is where, on a 12 hour clock face, you add 5 hours to 9. On the clock face, because here we are working with modular arithmetic, the solution is 2. </br>
     9+5=2(mod12) &emsp; -- because 14 is equivalent to 2 on a 12 hour clock face (14/12 = 1 R2 -> 14%12=2) </br>
   </br>
     The example above is actually quite easy to resolve, however, there exist a lot more complicated functions including hash functions.
     Hash functions always produce a fixed-length value no matter how much data is hashed. In case of the bitcoin blockchain, the hash algorithm SHA-256 always returns a hash with a length of 256 bits. </br>
     Also, as is the case with any function, the same input value will always return the same hash value. This is especially useful if you want to prove that two big datasets are equal without actually comparing every single data point. You can just hash both sets and if the hashes are identical, then so are the overall data sets. It is even possible to hash images or whole applications to proof their originality.
   </br> In order to better understand it, you can try it out right here! If you run out of ideas, try hashing two similar values, or twice the same value and see how the hash changes.</p>
</div>

<div class="hashingWrapper">
  <div class="hashdiv">
      <h2> Input: </h2>
      <textarea id="hashInput" style="background-color:white" placeholder="Type in anything you want!"></textarea>
    </div>
    <div>
      <button class="mybuttons w-button" onclick="calculateHash()"> Calculate the hash value!</button>
    </div>
    <div class="hashdiv">
      <h2> Output: </h2>
      <textarea readonly id="hashOutput" style="background-color:WHITESMOKE"></textarea>
    </div>
</div>

<div id="HistoryWrapper" class="usecasediv hash">
  <h2> History of hashed values </h2>
<table id="history" style="width:100%">
  ...
  <tr>
    <td>Hello World</td>
    <td>a591a6d40bf420404a011733cfb7b190d62c65bf0bcda32b57b277d9ad9f146e</td>
  </tr>
  <tr>
    <td>hello World</td>
    <td>53d3309c3be416093a0cf635c3d077793dee667b0872f35fdfa1d7b8dba2e766</td>
  </tr>
</table>
</div>
<script src="https://code.jquery.com/jquery-3.3.1.min.js" type="text/javascript" intergrity="sha256-FgpCb/KJQlLNfOu91ta32o/NMZxltwRo8QtmkMRdAu8=" crossorigin="anonymous"></script>
...
\anhangteil{Source code of transactions.html}
\begin{lstlisting}
<html data-wf-page="5ad485f0d8ce0281af7d3ecc" data-wf-site="5ad485f0d8ce021edb7d3ecd">
<head>
  <meta charset="utf-8">
