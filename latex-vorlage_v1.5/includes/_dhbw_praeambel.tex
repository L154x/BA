...
\usepackage{float}
\usepackage{colortbl}
\newcommand{\chapquote}[3]{\begin{quotation} {\itshape#1} \end{quotation} \begin{flushright} - #2, \textit{#3}\end{flushright} }
\usepackage{enumitem}
...
\input{includes/_dhbw_biblatex-config.tex} % mit DHBW-spezifischen Einstellungen
...
\input{includes/_dhbw_kopfzeilen.tex}		 % für schöne Kopfzeilen 
