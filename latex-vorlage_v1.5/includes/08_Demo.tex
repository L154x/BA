...
As the artifact's purpose is to give a short overview of the blockchain technology and its use cases to people who are yet unfamiliar with this technology, a 
...
%However, independent of the evaluation criteria,
...
%     \begin{subfigure}[b]{0.3\textwidth}
%             \begin{tikzpicture}
% 	        \begin{axis}[at={($(plot1.east)+(2cm,0)$)},
% 	            anchor=west,
% 	            xbar stacked,
%             	bar width=15pt,
%                 enlargelimits=0.15,
...
%                   anchor=north,legend columns=-1},
%                 xlabel={\# participants},
%                 symbolic y coords={6e, 6d, 6c, 6b, 6a},
%                 xmin= 0,
%                 xmax=9,
%                 ytick=data,
%             	]
%         	\addplot coordinates
%         		{(6,6e) (9,6d) (9,6c) (8,6b) (8,6a)};
%         	\addplot coordinates
%         		{(3,6e) (0,6d) (0,6c) (1,6b) (1,6a)};
%         	\legend{\strut yes, \strut no}
%         	\end{axis}
%             \end{tikzpicture}
...
Mehr Infos zu den Plots: http://www.bakoma-tex.com/doc/latex/pgfplots/pgfplots.pdf 
...
Another interesting aspect of the data is the increase of responses which mention \textit{Asset tracking} as a use case. It has increased from non-existent (0) to 7 appearances, with a growth rate (+7) surpassing that of \textit{Financial/sending value} (+6).
