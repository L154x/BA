...
%\bibliography{_BA_library.bib}
%\bibliography{_BA_library_2.bib}
\bibliography{_BA_library_Interviews.bib}
\bibliography{_PA_literatur.bib}
% \bibliography{BA_Blockchain.bib}
\bibliography{FINALLIT_2.bib}
...
\input{includes/02_blockchain.tex}
\input{latex-vorlage_v1.5/includes/03_Dashboard.tex}
\input{latex-vorlage_v1.5/includes/04_DesignScience.tex}
\input{latex-vorlage_v1.5/includes/05_RE.tex}
\input{latex-vorlage_v1.5/includes/06_Solution.tex}
\input{latex-vorlage_v1.5/includes/07_DesignArtifact.tex}
\input{latex-vorlage_v1.5/includes/08_Demo.tex}
\input{latex-vorlage_v1.5/includes/10_Conclusion.tex}
\input{latex-vorlage_v1.5/includes/anhang.tex}
...
\printbibliography[heading=lit, notkeyword=gespraech,notkeyword=ausblenden]
%,nottype=online
...
\cleardoublepage
\input{includes/_dhbw_erklaerung.tex}
